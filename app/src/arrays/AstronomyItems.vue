...
const astronomyObjects = [
  {
    ...
    type: 'Star',
    imageURL: '/WR124.jpg',
    altText: 'Wolf-Rayet 124 as seen in a composite image from the James Webb Space Telescope.',
    discoveryYear: 1938,
    notableFeatures:
  ...
  },
  {
    ...
    type: 'Galaxy',
    imageURL: '/jelly.jpg',
    altText: 'Hubble image of ESO 137-001 displaying a long tail created by gas stripping.',
    discoveryYear: 2005,
    notableFeatures:
...

  {
    ...
    type: 'Nebula',
    imageURL: '/veil.jpg',
    altText: 'Hubble image of a small region of the Veil Nebula spanning 2 light years',
    discoveryYear: 1784,
    notableFeatures:
  ...
  {
    name: 'W2246-0526',
    distanceLightYears: 12400000000,
    type: 'Galaxy',
    imageURL: '/WISE.jpg',
    altText: "Artist's impression of the extremely luminous infrared galaxy W2246-0526",
    discoveryYear: 1689,
    notableFeatures:
  ...
  {
    name: 'Bubble Nebula',
    distanceLightYears: 7100,
    type: 'Nebula',
    imageURL: '/buble.jpg',
    altText: 'Wide field image of NGC 7635 as captured by the Hubble Space Telescope.',
    discoveryYear: 1787,
    notableFeatures:
  ...
  },
  {
    ...
    discoveryYear: 2011,
    notableFeatures:
      'Was the most distant known quasar when discovered in 2011, powered by a supermassive black hole with a mass two billion times that of the Sun, with an estimated luminosity of 63 trillion solar luminosities, or a causal 63 trillion times brighter than our sun (outshining entire galaxies.) The quasar emitted the light observed on Earth today less than 770 million years after the Big Bang, about 13 billion years ago, 100 million years earlier than light from the most distant previously known quasar. ',
  },
  {
  ...
  },
  {
    ...
    type: 'Nebula',
    imageURL: '/EyeOfGod.jpg',
    altText: 'NGC 7293 seen through several visible filters by Hubble Space Telescope',
    discoveryYear: 1824,
    notableFeatures:
      "The Helix Nebula (NGC 7293) is one of the closest and brightest planetary nebulae to Earth. Formed from the expelled outer layers of a dying star, it has a striking appearance resembling a helix or an eye, giving rise to it being referred to as the 'Eye of God' as well as the 'Eye of Sauron'. The central star, a white dwarf, heats the surrounding gas causing it to glow brightly.",
  },
  {
    name: 'Orion Nebula',
  ...
  },
  {
    ...
    type: 'Galaxy',
    imageURL: '/lmc.jpg',
    altText: 'A map of the Large Magellanic Cloud with the brightest features annotated',
    discoveryYear: 1519,
    notableFeatures:
